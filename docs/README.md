...
- [Next.js Route Handlers + RSC design](./superpowers/specs/2026-08-11-nextjs-route-handlers-design.md) — opt-in domain-agnostic App Router adapter (`--next-surface both|routes|rsc`; OpenAPI → `route.ts` and/or RSC pages; Hono stays default)
