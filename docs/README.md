...
- [Next.js Route Handlers + RSC design](./superpowers/specs/2026-08-11-nextjs-route-handlers-design.md) — opt-in domain-agnostic App Router adapter; vanilla PetShop dogfood (`create-next-app` + `vp`/pnpm; no app tests)
