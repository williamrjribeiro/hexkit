...
- [Pet Store OpenAPI progress](./petstore-openapi-progress.md) — Hono & Next.js feature tracker toward the **full** Petstore OpenAPI (`missing` / `in progress` / `shipped`; keep current)
