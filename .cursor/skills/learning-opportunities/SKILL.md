...
description: Use when completing architectural work (new files, schema changes, refactors), finishing features, making design decisions, or when the user asks to understand code better or wants a learning exercise. Also use when invoked as /learning-opportunities or with the orient argument.
...
>
> Vendored from [DrCatHicks/learning-opportunities](https://github.com/DrCatHicks/learning-opportunities) (CC BY 4.0). See `ATTRIBUTION.md`.
...
1. `.cursor/skills/learning-opportunities/resources/orientation.md` (Cursor project level)
2. `.agents/skills/learning-opportunities/resources/orientation.md` (vendor-neutral project level)
3. `.codex/skills/learning-opportunities/resources/orientation.md` (Codex project level)
4. `.claude/skills/learning-opportunities/resources/orientation.md` (Claude Code project level)
5. `~/.cursor/skills/learning-opportunities/resources/orientation.md` (Cursor user level)
6. `~/.codex/skills/learning-opportunities/resources/orientation.md` (Codex user level)
7. `~/.claude/skills/learning-opportunities/resources/orientation.md` (Claude Code user level)

If the file does not exist at any location, stop and tell the user:

> "No orientation file found. Invoke the orient skill first to generate one for this repo. It takes about 30 seconds."

See [orient](https://github.com/DrCatHicks/learning-opportunities/tree/main/orient) for the plugin that generates orientation files.
