...
type updatePetParsedParams = {
  body?: StandardSchemaV1.InferOutput<
    (typeof updatePetRequestMap)[keyof typeof updatePetRequestMap]
  >;
};
...
export function updatePetWrapper(handler: updatePetHandler) {
  return async (req: {
    query: unknown;
    path: unknown;
    headers: unknown;
    ...
    let parsedBody:
      | StandardSchemaV1.InferOutput<(typeof updatePetRequestMap)[keyof typeof updatePetRequestMap]>
      | undefined = undefined;
