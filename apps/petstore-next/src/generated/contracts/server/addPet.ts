...
type addPetParsedParams = {
  body?: StandardSchemaV1.InferOutput<(typeof addPetRequestMap)[keyof typeof addPetRequestMap]>;
};
...
export function addPetWrapper(handler: addPetHandler) {
  return async (req: {
    query: unknown;
    path: unknown;
    headers: unknown;
    ...
    let parsedBody:
      | StandardSchemaV1.InferOutput<(typeof addPetRequestMap)[keyof typeof addPetRequestMap]>
      | undefined = undefined;
    if (req.body !== undefined) {
      ...
      if (schema) {
        ...
        parsedBody = bodyParse.value as StandardSchemaV1.InferOutput<
          (typeof addPetRequestMap)[keyof typeof addPetRequestMap]
        >;
      } else {
